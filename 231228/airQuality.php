<?php
$aq = $_POST["aq"];
$data = file_get_contents('https://data.epa.gov.tw/api/v2/aqx_p_432?api_key=e8dd42e6-9b8b-43f8-991e-b3dee723a52d&limit=1000&sort=ImportDate%20desc&format=CSV');
$rows = explode("\n",$data);
$s = array();
$num=0;
foreach($rows as $row) {
